    ...
    <div className="flex flex-col h-full bg-[#1F1F1F] dark:bg-[#0F0F0F] transition-colors duration-200">
      ...
      <div className="flex-1 p-6 overflow-y-auto">
        <div className="max-w-2xl mx-auto space-y-6">
          ...
          {/* Theme Section */}
          <div className="bg-white dark:bg-[#19324B] rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden transition-colors duration-200">
            ...
            <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              >
                <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
                  currentTheme === 'light' ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-400 dark:bg-[#284664]'
                }`}>
                  <Sun size={20} />
                </div>
              ...
              >
                <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
                  currentTheme === 'dark' ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-400 dark:bg-[#284664]'
                }`}>
                  <Moon size={20} />
                </div>
                <div className="text-left">
          ...
          <div className="bg-white dark:bg-[#19324B] rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden transition-colors duration-200">
            ...
            <div className="p-6">
              ...
              <div className="bg-slate-100 dark:bg-[#284664] p-1 rounded-lg flex gap-1">
                <button
                  onClick={() => onFontSizeChange('small')}
                  className={`flex-1 py-3 rounded-md text-sm font-medium transition-all ${
                    currentFontSize === 'small'
                      ? 'bg-white dark:bg-[#375A7D] text-blue-600 dark:text-blue-300 shadow-sm'
              ...
              <div className="mt-6 p-4 bg-slate-50 dark:bg-[#0F0F0F]/50 rounded-lg border border-slate-200 dark:border-slate-700">
